...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d",
        "--data",
        help="Path to the directory containing actes",
        type=str,
        required=True,
    )
    parser.add_argument(
        "-m",
        "--metadata",
        help="Path to the directory containing metadatas",
        type=str,
        required=True,
    )
    parser.add_argument(
        "-s",
        "--save",
        help="Path where to save the pipeline",
        type=str,
        required=False,
        default=None,
    )
    parser.add_argument(
        "-b",
        "--database",
        help="True to send the result to the database",
        type=bool,
        required=False,
        default=False,
    )
