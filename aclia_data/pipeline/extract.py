...
def get_metadata_pdf(path):
    ...
    :returns: A tuple containing the type of pdf (image/text), producer,
    creation_date, number of pages in the pdf, number of files (acte + pj),
    name of the acte principal
    """
