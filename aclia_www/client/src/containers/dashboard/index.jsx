            ...
            <Content style={ { marginTop: '94px'} }>
                <Row>
                    <Spin spinning={ isPending } indicator={ antIcon }>
                        ...
                        <Col xs={ { span: 5, offset: 1 } } lg={ { span: 6, offset: 2 } }>
                            <Card title={ 'Annotation par département' } headStyle={ {textAlign: 'center', fontWeight:'bold'} }>
                                <Table dataSource={ data } columns={ columns } rowKey={ record => record.dept } />
                            </Card>
                        </Col>
                    </Spin>
                </Row>
